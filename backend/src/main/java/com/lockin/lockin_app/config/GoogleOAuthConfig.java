...
/**
 * Configuration for Google OAuth2 calendar integration.
 *
 * Loads OAuth settings from application.properties:
 * - google.oauth.client-id
 * - google.oauth.client-secret
 * - google.oauth.redirect-uri
 * - google.oauth.scopes
 *
 * SECURITY: Client secret should be loaded from environment variables!
 */
@Slf4j
@Data
@Configuration
...
public class GoogleOAuthConfig {
    ...
    public void validate() {
        ...
        // Warn if redirect URI doesn't have trailing slash (common OAuth issue!)
        ...
        // Never log client ID or secret!
    }

    /**
     * Check if OAuth is properly configured.
     * Useful for showing UI state.
     */
