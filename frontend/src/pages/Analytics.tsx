  ...
  return (
    <Box>
      ...
      {streakData && streakData.currentStreak > 0 && (
        <Paper sx={{ p: 2, mb: 3, bgcolor: 'success.lighter', border: '2px solid', borderColor: 'success.main' }}>
          <Box display="flex" alignItems="center" justifyContent="space-between" flexWrap="wrap" gap={2}>
            ...
            {streakData.currentStreak >= 7 && (
              <Chip
                label={streakData.currentStreak >= 30 ? "🏆 Legendary!" : streakData.currentStreak >= 14 ? "⭐ Amazing!" : "💪 On Fire!"}
                color="success"
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                ...
                {comparisonData && comparisonData.current.breakMinutes > 0 && (
                  <> • {Math.floor(comparisonData.current.breakMinutes / 60)}h {comparisonData.current.breakMinutes % 60}m breaks</>
                )}
              </Typography>
              ...
              {comparisonData && comparisonData.current.focusMinutes > 0 && comparisonData.current.breakMinutes > 0 && (
                <Typography variant="caption" color="success.main" display="block">
                  Ratio {(comparisonData.current.focusMinutes / comparisonData.current.breakMinutes).toFixed(1)}:1 (work:break)
                </Typography>
              )}
              {comparisonData && (
                <Box display="flex" alignItems="center" gap={1}>
      ...
      {rangeData.length > 0 && (
        <>
          ...
          {/* Eisenhower Matrix */}
          {todayAnalytics && (todayAnalytics.urgentImportantCount + todayAnalytics.notUrgentImportantCount +
            todayAnalytics.urgentNotImportantCount + todayAnalytics.notUrgentNotImportantCount) > 0 && (
            <Paper sx={{ p: 3, mb: 3 }}>
              <Typography variant="h6" gutterBottom>
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ height: '100%', border: '2px solid', borderColor: 'error.main', bgcolor: 'error.lighter' }}>
                    <CardContent>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Do First - Critical tasks requiring immediate attention
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ height: '100%', border: '2px solid', borderColor: 'success.main', bgcolor: 'success.lighter' }}>
                    <CardContent>
                      <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ height: '100%', border: '2px solid', borderColor: 'warning.main', bgcolor: 'warning.lighter' }}>
                    <CardContent>
                      <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  <Card sx={{ height: '100%', border: '2px solid', borderColor: 'grey.400', bgcolor: 'grey.100' }}>
                    <CardContent>
                      <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
