...
import calendarService, { CalendarStatus } from "../../services/calendarService";
        ...
        {!status?.connected ? (
          <>
            <Alert severity="info" sx={{ mb: 2 }}>
              Connect your Google Calendar to automatically sync tasks with due dates.
            </Alert>
            <Button
              variant="contained"
              startIcon={connecting ? <CircularProgress size={20} /> : <CalendarIcon />}
          ...
          <>
            ...
            <Alert severity="success" sx={{ mb: 2 }}>
              Tasks with due dates will automatically sync to Google Calendar every 15 minutes.
            </Alert>
